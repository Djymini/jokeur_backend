...
public class HealthRecordExportController {
  ...
  public ResponseEntity<byte[]> exportPdf(@PathVariable Long healthRecordId, @Valid @RequestBody HealthRecordExportRequest request) {
  ...
  public ResponseEntity<byte[]> exportXlsx(@PathVariable Long healthRecordId, @Valid @RequestBody HealthRecordExportRequest request) {
